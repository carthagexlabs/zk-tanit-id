...
export function ProofGenerationStep({ userData, onNext, onBack, onProofGenerated }: ProofGenerationStepProps) {
  ...
  useEffect(() => {
    ...
    const generateProof = async () => {
      ...
      // Create the proof data object and pass it to parent
      const generatedProofData: ProofData = {
        proof: mockProof,
        publicInputs: {
          claim: userData.verificationClaim,
          // Public inputs do NOT include sensitive data
          // Only the claim type and verification result
          verified: true,
        },
      ...
      // Pass proof data to parent component
