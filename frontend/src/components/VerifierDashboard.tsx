...
import { verifyProof } from "../sdk/zktanitid";
...
export default function VerifierDashboard() {
  ...
  return (
    <section style={{ marginTop: 24, padding: 12, border: "1px solid #eaeaea", borderRadius: 12 }}>
      <h2>Verifier Dashboard (Bank / Gov Simulation)</h2>
      <p>Paste a proof JSON (from the Wallet UI) and verify it like a bank or government service would.</p>
