...
export function Hero({ onStart }: HeroProps) {
  ...
  return (
    <section className="relative py-12 px-4 sm:px-6 lg:px-8 pt-24 overflow-hidden">
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-8 space-y-10">
          ...
          <div className="space-y-4">
            <h1 className="transform translate-y-10 opacity-0 animate-[slideInUp_0.6s_ease-out_0.4s_forwards] text-5xl md:text-6xl font-bold leading-tight">
              <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300 inline-block">
                Prove, Don't Expose
              </span>
            </h1>

            <p className="text-sm text-slate-500 max-w-xl mx-auto leading-relaxed transform translate-y-10 opacity-0 animate-[slideInUp_0.6s_ease-out_0.6s_forwards]">
